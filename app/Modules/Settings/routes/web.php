...
Route::group(array('Module'=>'Settings'), function () {
    ...
    Route::get('/dashboard/social_media', [SocialMediaController::class, 'socialMedia']);
    ...
    // api routes ---------------------------
    Route::get('/dashboard/settings/email_configuration/get', [EmailConfigurationController::class, 'getEmailConfiguration']);
    ...
    Route::get('/dashboard/settings/captcha_configuration/get', [CaptchaConfigurationController::class, 'getCaptchaConfiguration']);
    ...
    Route::get('/dashboard/settings/payment_configuration/get', [PaymentConfigurationController::class, 'getPaymentConfiguration']);
    ...
    Route::get('/dashboard/settings/general_settings/get', [GeneralSettingsController::class, 'getGeneralSettings']);
    ...
    Route::get('/dashboard/social_media/get', [SocialMediaController::class, 'getSocialMedia']);
