                                    ...
                                    <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="card shadow-sm p-3">
                                            ...
                                            <div class="form-group">
                                                <label for="" class="control-label"></label>
                                                <div class="">
                                                    <button onclick="updateGeneralSettings()" class="btn codefotech_color pull-left" onclick="updateGeneralSettings()">
                                            ...
                                            <form class="form-horizontal" enctype="multipart/form-data"
                                                ...
                                                <div class="card shadow-sm p-3">
                                                    ...
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <div class="" style="padding-top:6px;">
                                                            <img src="{{ asset($pagesData['image'] ?? 'assets-1/img/default-img.jpg') }}" class="existing-photo" id="old_image" style="height:80px;">
                                                            <br><br>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_desination" id="heroform_desination" class="form-control">
                                                            <option value="Dhaka" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Dhaka' ? 'selected' : '' }}>Dhaka</option>
                                                            <option value="Chattogram" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Chattogram' ? 'selected' : '' }}>Chattogram</option>
                                                            <option value="Barishal" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Barishal' ? 'selected' : '' }}>Barishal</option>
                                                            <option value="Dhaka" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Dhaka' ? 'selected' : '' }}>Dhaka</option>
                                                            <option value="Khulna" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Khulna' ? 'selected' : '' }}>Khulna</option>
                                                            <option value="Rajshahi" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Rajshahi' ? 'selected' : '' }}>Rajshahi</option>
                                                            <option value="Rangpur" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Rangpur' ? 'selected' : '' }}>Rangpur</option>
                                                            <option value="Mymensingh" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Mymensingh' ? 'selected' : '' }}>Mymensingh</option>
                                                            <option value="Sylhet" {{ isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Sylhet' ? 'selected' : '' }}>Sylhet</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_trip_type" id="heroform_trip_type" class="form-control">
                                                            <option value="Holiday Package" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Holiday Package' ? 'selected' : '' }}>Holiday Package</option>
                                                            <option value="Full Of FamJam" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Full Of FamJam' ? 'selected' : '' }}>Full Of FamJam</option>
                                                            <option value="Friends-Only Trip" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Friends-Only Trip' ? 'selected' : '' }}>Friends-Only Trip</option>
                                                            <option value="Siblings-Only Trip" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Siblings-Only Trip' ? 'selected' : '' }}>Siblings-Only Trip</option>
                                                            <option value="All-Girls Or An All-Boys Trip" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'All-Girls Or An All-Boys Trip' ? 'selected' : '' }}>All-Girls Or An All-Boys Trip</option>
                                                            <option value="Volunteer Trip" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Volunteer Trip' ? 'selected' : '' }}>Volunteer Trip</option>
                                                            <option value="Impromptu Trip" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Impromptu Trip' ? 'selected' : '' }}>Impromptu Trip</option>
                                                            <option value="Solo Trip" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Solo Trip' ? 'selected' : '' }}>Solo Trip</option>
                                                            <option value="Adventure Trip" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Adventure Trip' ? 'selected' : '' }}>Adventure Trip</option>
                                                            <option value="Luxury Trip" {{ isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Luxury Trip' ? 'selected' : '' }}>Luxury Trip</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_trip_activities" id="heroform_trip_activities" class="form-control">
                                                            <option value="Star Line" {{ isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Star Line' ? 'selected' : '' }}>Star Line</option>
                                                            <option value="Green Line" {{ isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Green Line' ? 'selected' : '' }}>Green Line</option>
                                                            <option value="Hanif Enterprise" {{ isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Hanif Enterprise' ? 'selected' : '' }}>Hanif Enterprise</option>
                                                            <option value="Shyamoli Paribahan" {{ isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Shyamoli Paribahan' ? 'selected' : '' }}>Shyamoli Paribahan</option>
                                                            <option value="Shohag Paribahan" {{ isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Shohag Paribahan' ? 'selected' : '' }}>Shohag Paribahan</option>
                                                            <option value="Ena Transport" {{ isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Ena Transport' ? 'selected' : '' }}>Ena Transport</option>
                                                            <option value="London Express" {{ isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'London Express' ? 'selected' : '' }}>London Express</option>
                                                            <option value="Saint Martin Paribahan" {{ isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Saint Martin Paribahan' ? 'selected' : '' }}>Saint Martin Paribahan</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_days" id="heroform_days" class="form-control">
                                                            <option value="0 Days - 1 Days" {{ isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 1 Days' ? 'selected' : '' }}>0 Days - 1 Days</option>
                                                            <option value="0 Days - 3 Days" {{ isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 3 Days' ? 'selected' : '' }}>0 Days - 3 Days</option>
                                                            <option value="0 Days - 5 Days" {{ isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 5 Days' ? 'selected' : '' }}>0 Days - 5 Days</option>
                                                            <option value="0 Days - 7 Days" {{ isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 7 Days' ? 'selected' : '' }}>0 Days - 7 Days</option>
                                                            <option value="0 Days - 10 Days" {{ isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 10 Days' ? 'selected' : '' }}>0 Days - 10 Days</option>
                                                            <option value="0 Days - 14 Days" {{ isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 14 Days' ? 'selected' : '' }}>0 Days - 14 Days</option>
                                                            <option value="0 Days - 30 Days" {{ isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 30 Days' ? 'selected' : '' }}>0 Days - 30 Days</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_budget" id="heroform_budget" class="form-control">
                                                            <option value="$100 - $150" {{ isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$100 - $150' ? 'selected' : '' }}>$100 - $150</option>
                                                            <option value="$150 - $200" {{ isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$150 - $200' ? 'selected' : '' }}>$150 - $200</option>
                                                            <option value="$200 - $250" {{ isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$200 - $250' ? 'selected' : '' }}>$200 - $250</option>
                                                            <option value="$250 - $350" {{ isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$250 - $350' ? 'selected' : '' }}>$250 - $350</option>
                                                            <option value="$250 - $500" {{ isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$250 - $500' ? 'selected' : '' }}>$250 - $500</option>
                                                            <option value="$500 - $1000" {{ isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$500 - $1000' ? 'selected' : '' }}>$500 - $1000</option>
                                                        </select>
                                                    </div>
