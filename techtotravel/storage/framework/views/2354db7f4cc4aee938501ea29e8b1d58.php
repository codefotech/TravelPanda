    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="content-header">
            <div class="d-flex position-relative">
                ...
                <h2 class="py-3 pl-2">&nbsp; Dashboard</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TechToTravel\techtotravel\app\Modules/Dashboard/resources/views/dashboard.blade.php ENDPATH**/ ?>