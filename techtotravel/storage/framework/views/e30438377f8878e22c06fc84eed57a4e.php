                                    ...
                                    <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="card shadow-sm p-3">
                                            <div class="form-group pb-3">
                                                ...
                                                <div class="pt-3">
                                                    <img src="<?php echo e(asset($generalSettingsData['logo'] ?? 'assets-1/img/default-img.jpg')); ?>" class="existing-photo" id="logo_old_image" style="height:80px;">
                                                    <br><br>
                                                    <input oninput="logo_old_image.src=window.URL.createObjectURL(this.files[0])" type="file" class="form-control" id="logoImgUpdate">
                                                    <br>
                                                    <input type="text" class="form-control" id="logoFilePath" value="<?php echo e($generalSettingsData['logo'] ?? ''); ?>" readonly disabled>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card shadow-sm p-3">
                                            <div class="form-group pb-3">
                                                ...
                                                <div class="" style="padding-top:6px;">
                                                    <img src="<?php echo e(asset($generalSettingsData['favicon'] ?? 'assets-1/img/default-img.jpg')); ?>" class="existing-photo" id="favicon_old_image" style="height:40px;">
                                                    <br><br>
                                                ...
                                                <div class="card shadow-sm p-3">
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="user_types" id="user_types" class="form-control">
                                                            <option value="Admin" <?php echo e(isset($generalSettingsData['user_types']) && $generalSettingsData['user_types'] == 'Admin' ? 'selected' : ''); ?>>Admin</option>
                                                            <option value="User" <?php echo e(isset($generalSettingsData['user_types']) && $generalSettingsData['user_types'] == 'User' ? 'selected' : ''); ?>>User</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3">
                                                        ...
                                                        <div class="" style="padding-top:6px;">
                                                            <img src="<?php echo e(asset($pagesData['image'] ?? 'assets-1/img/default-img.jpg')); ?>" class="existing-photo" id="old_image" style="height:80px;">
                                                            <br><br>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_desination" id="heroform_desination" class="form-control">
                                                            <option value="Dhaka" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Dhaka' ? 'selected' : ''); ?>>Dhaka</option>
                                                            <option value="Chattogram" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Chattogram' ? 'selected' : ''); ?>>Chattogram</option>
                                                            <option value="Barishal" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Barishal' ? 'selected' : ''); ?>>Barishal</option>
                                                            <option value="Dhaka" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Dhaka' ? 'selected' : ''); ?>>Dhaka</option>
                                                            <option value="Khulna" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Khulna' ? 'selected' : ''); ?>>Khulna</option>
                                                            <option value="Rajshahi" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Rajshahi' ? 'selected' : ''); ?>>Rajshahi</option>
                                                            <option value="Rangpur" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Rangpur' ? 'selected' : ''); ?>>Rangpur</option>
                                                            <option value="Mymensingh" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Mymensingh' ? 'selected' : ''); ?>>Mymensingh</option>
                                                            <option value="Sylhet" <?php echo e(isset($pagesData['heroform_desination']) && $pagesData['heroform_desination'] == 'Sylhet' ? 'selected' : ''); ?>>Sylhet</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_trip_type" id="heroform_trip_type" class="form-control">
                                                            <option value="Holiday Package" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Holiday Package' ? 'selected' : ''); ?>>Holiday Package</option>
                                                            <option value="Full Of FamJam" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Full Of FamJam' ? 'selected' : ''); ?>>Full Of FamJam</option>
                                                            <option value="Friends-Only Trip" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Friends-Only Trip' ? 'selected' : ''); ?>>Friends-Only Trip</option>
                                                            <option value="Siblings-Only Trip" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Siblings-Only Trip' ? 'selected' : ''); ?>>Siblings-Only Trip</option>
                                                            <option value="All-Girls Or An All-Boys Trip" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'All-Girls Or An All-Boys Trip' ? 'selected' : ''); ?>>All-Girls Or An All-Boys Trip</option>
                                                            <option value="Volunteer Trip" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Volunteer Trip' ? 'selected' : ''); ?>>Volunteer Trip</option>
                                                            <option value="Impromptu Trip" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Impromptu Trip' ? 'selected' : ''); ?>>Impromptu Trip</option>
                                                            <option value="Solo Trip" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Solo Trip' ? 'selected' : ''); ?>>Solo Trip</option>
                                                            <option value="Adventure Trip" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Adventure Trip' ? 'selected' : ''); ?>>Adventure Trip</option>
                                                            <option value="Luxury Trip" <?php echo e(isset($pagesData['heroform_trip_type']) && $pagesData['heroform_trip_type'] == 'Luxury Trip' ? 'selected' : ''); ?>>Luxury Trip</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_trip_activities" id="heroform_trip_activities" class="form-control">
                                                            <option value="Star Line" <?php echo e(isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Star Line' ? 'selected' : ''); ?>>Star Line</option>
                                                            <option value="Green Line" <?php echo e(isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Green Line' ? 'selected' : ''); ?>>Green Line</option>
                                                            <option value="Hanif Enterprise" <?php echo e(isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Hanif Enterprise' ? 'selected' : ''); ?>>Hanif Enterprise</option>
                                                            <option value="Shyamoli Paribahan" <?php echo e(isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Shyamoli Paribahan' ? 'selected' : ''); ?>>Shyamoli Paribahan</option>
                                                            <option value="Shohag Paribahan" <?php echo e(isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Shohag Paribahan' ? 'selected' : ''); ?>>Shohag Paribahan</option>
                                                            <option value="Ena Transport" <?php echo e(isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Ena Transport' ? 'selected' : ''); ?>>Ena Transport</option>
                                                            <option value="London Express" <?php echo e(isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'London Express' ? 'selected' : ''); ?>>London Express</option>
                                                            <option value="Saint Martin Paribahan" <?php echo e(isset($pagesData['heroform_trip_activities']) && $pagesData['heroform_trip_activities'] == 'Saint Martin Paribahan' ? 'selected' : ''); ?>>Saint Martin Paribahan</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_days" id="heroform_days" class="form-control">
                                                            <option value="0 Days - 1 Days" <?php echo e(isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 1 Days' ? 'selected' : ''); ?>>0 Days - 1 Days</option>
                                                            <option value="0 Days - 3 Days" <?php echo e(isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 3 Days' ? 'selected' : ''); ?>>0 Days - 3 Days</option>
                                                            <option value="0 Days - 5 Days" <?php echo e(isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 5 Days' ? 'selected' : ''); ?>>0 Days - 5 Days</option>
                                                            <option value="0 Days - 7 Days" <?php echo e(isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 7 Days' ? 'selected' : ''); ?>>0 Days - 7 Days</option>
                                                            <option value="0 Days - 10 Days" <?php echo e(isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 10 Days' ? 'selected' : ''); ?>>0 Days - 10 Days</option>
                                                            <option value="0 Days - 14 Days" <?php echo e(isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 14 Days' ? 'selected' : ''); ?>>0 Days - 14 Days</option>
                                                            <option value="0 Days - 30 Days" <?php echo e(isset($pagesData['heroform_days']) && $pagesData['heroform_days'] == '0 Days - 30 Days' ? 'selected' : ''); ?>>0 Days - 30 Days</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group pb-3" style="padding-top:7px;">
                                                        ...
                                                        <select name="heroform_budget" id="heroform_budget" class="form-control">
                                                            <option value="$100 - $150" <?php echo e(isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$100 - $150' ? 'selected' : ''); ?>>$100 - $150</option>
                                                            <option value="$150 - $200" <?php echo e(isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$150 - $200' ? 'selected' : ''); ?>>$150 - $200</option>
                                                            <option value="$200 - $250" <?php echo e(isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$200 - $250' ? 'selected' : ''); ?>>$200 - $250</option>
                                                            <option value="$250 - $350" <?php echo e(isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$250 - $350' ? 'selected' : ''); ?>>$250 - $350</option>
                                                            <option value="$250 - $500" <?php echo e(isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$250 - $500' ? 'selected' : ''); ?>>$250 - $500</option>
                                                            <option value="$500 - $1000" <?php echo e(isset($pagesData['heroform_budget']) && $pagesData['heroform_budget'] == '$500 - $1000' ? 'selected' : ''); ?>>$500 - $1000</option>
                                                        </select>
                                                    </div>
                                                        ...
                                                        <tr>
                                                            <form enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                                                <td style="width:50%">
                                                                    ...
                                                                    <p>
                                                                        <img src="<?php echo e(asset($generalSettingsData['banner'] ?? 'assets-1/img/default-img.jpg')); ?>"
    ...
    <script>
        ...
        async function getGeneralSettings() {
            try {
                ...
                if (res.status === 200 && res.data.status === 'success') {
                    ...
                    document.getElementById('logo_old_image').src = data.logo ?? '<?php echo e(asset('assets-1/img/default-img.jpg')); ?>';
                    document.getElementById('faviconFilePath').value = data.favicon ?? '';
                    document.getElementById('favicon_old_image').src = data.favicon ?? '<?php echo e(asset('assets-1/img/default-img.jpg')); ?>';
                    document.getElementById('bannerFilePath').value = data.banner ?? '';
                    document.getElementById('banner_old_image').src = data.banner ?? '<?php echo e(asset('assets-1/img/default-img.jpg')); ?>';
        ...
        async function getPages() {
            try {
                ...
                if (res.status === 200 && res.data.status === 'success') {
                    ...
                    errorToast('Failed to fetch pages');
                }
            } catch (error) {
                console.error('Error fetching pages:', error);
                errorToast('An error occurred while fetching pages');
            }
        }
        ...
        async function updatePages() {
            try {
                ...
                let res = await axios.post('/dashboard/settings/pages/update', formData, config);
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TechToTravel\techtotravel\app\Modules/Settings/resources/views/general_settings.blade.php ENDPATH**/ ?>
